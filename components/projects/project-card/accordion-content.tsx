            ...
            <div className="scalable grid gap-6 pr-10 pb-12">
              ...
              {tags.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {tags.map((tag) => (
                    <span key={tag} className="border-gray5 text-gray7 text-16 rounded-lg border px-3">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              {url && (
                <Link
                  ...
                  className="text-16 text-lightgray relative w-fit transition-colors duration-300 hover:text-white"
                >
