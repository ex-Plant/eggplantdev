    ...
    <div className="flex items-center justify-between gap-3">
      ...
      <div className="flex items-center gap-2" role="group" aria-labelledby="font-size-label">
        ...
        <input
          ...
          className="bg-gray5 h-1 w-20 cursor-pointer appearance-none rounded outline-none [&::-webkit-slider-thumb]:h-3.5 [&::-webkit-slider-thumb]:w-3.5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:transition-shadow focus-visible:[&::-webkit-slider-thumb]:shadow-[0_0_0_4px_rgba(255,255,255,0.3)]"
        />
        <button
          type="button"
          onClick={() => setScale(scale + STEP)}
