...
export const OUTER_CIRCLES_GOLD = [
  { r: 200, stroke: PALETTE_GOLD.warmGold, strokeWidth: 0.3, opacity: 0.1, dasharray: "8 12" },
  { r: 300, stroke: PALETTE_GOLD.darkGold, strokeWidth: 0.3, opacity: 0.06, dasharray: "4 16" },
  { r: 380, stroke: PALETTE_GOLD.gold, strokeWidth: 0.2, opacity: 0.04, dasharray: undefined },
] as const;
