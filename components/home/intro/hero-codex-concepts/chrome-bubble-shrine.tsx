    ...
    >
        <div className="640:col-span-8 1280:col-span-10 col-span-full 1280:col-start-7 mt-12 min-h-[33rem] overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(26,12,28,0.86),rgba(10,8,12,0.96))] xl:mt-0">
          <div className="relative grid min-h-[33rem] place-items-center overflow-hidden">
            <div className="absolute h-[26rem] w-[26rem] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.24),rgba(244,114,182,0.18)_22%,rgba(192,132,252,0.18)_42%,transparent_68%)]" />
            <div className="absolute left-1/2 top-1/2 h-[19rem] w-[19rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/18 bg-white/8" />
            ...
            <div className="absolute left-[28%] top-[22%] h-12 w-28 rotate-[-16deg] rounded-full bg-white/14 opacity-60" />
            <div className="absolute right-[26%] bottom-[20%] h-10 w-24 rotate-[18deg] rounded-full bg-[#f5d0fe]/12 opacity-60" />
            ...
            <div className="absolute bottom-8 left-1/2 w-[min(92%,33rem)] -translate-x-1/2 rounded-[1.65rem] border border-white/10 bg-[linear-gradient(180deg,rgba(28,14,31,0.9),rgba(10,8,12,0.97))] p-6 text-center">
