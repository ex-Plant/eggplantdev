...
export const NEBULA_CLOUDS = [
  {
    ...
    size: "h-[70%] w-[50%]",
    gradient: "radial-gradient(ellipse,rgba(218,165,32,0.12),transparent_75%)",
  },
  {
    position: "right-[5%] top-[10%]",
    size: "h-[60%] w-[45%]",
    gradient: "radial-gradient(ellipse,rgba(200,134,14,0.06),transparent_75%)",
  },
  {
    position: "bottom-[10%] left-[30%]",
    size: "h-[50%] w-[55%]",
    gradient: "radial-gradient(ellipse,rgba(240,192,64,0.06),transparent_75%)",
  },
] as const;
